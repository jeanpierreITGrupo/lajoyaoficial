...
class account_account(models.Model):
	...
	es_analisis = fields.Boolean(u'¿Cuenta para Análisis?',default=False)
...
where (account_account.type='receivable' or account_account.type='payable' ) and account_account.es_analisis = true
...
order by empresa, code, nro_comprobante
		...
		if self.mostrar == 'excel':
			...
			worksheet.write(9,2, "Ruc",boldbord)
