	...
	def generar(self):
		...
		if invoice.currency_id.name == 'USD':
			...
			line_cc = (0,0,{
				...
				'debit': round(self.monto * invoice.currency_rate_auto,0),
				...
				'amount_currency': round(round(self.monto * invoice.currency_rate_auto,0)/invoice.currency_rate_auto,2) ,
			...
			line_cc = (0,0,{
				...
				'debit': 0,
				'credit':round(self.monto * invoice.currency_rate_auto,0),
...
class account_invoice(models.Model):
	...
	name_move_detraccion = fields.Char('nombre detraccion',copy=False)
	diario_move_detraccion = fields.Many2one('account.journal','nombre diario',copy=False)
	periodo_move_detraccion = fields.Many2one('account.period','Periodo',copy=False)
