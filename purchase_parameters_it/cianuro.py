...
class table_cianuro(models.Model):
	_name = 'table.cianuro'
	...
	_sql_constraints = [
        ('cianuro_uniq', 'unique(mineral_type, date, param1, param2)', u'La ley no puede tener misma fecha y parámetros.'),
    ]
	...
	def create(self,vals):
		...
		return super(table_cianuro,self).create(vals)
