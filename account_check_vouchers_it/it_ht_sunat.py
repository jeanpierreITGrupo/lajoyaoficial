...
class account_voucher(models.Model):
	...
	def voucher_move_line_create(self, cr, uid, voucher_id, line_total, move_id, company_currency, current_currency, context=None):
		...
		for line in voucher.line_ids:
			...
			parameter_gene = self.pool.get('main.parameter').search(cr,uid,[],context=context)[0]
			parameter_obj = self.pool.get('main.parameter').browse(cr,uid,parameter_gene,context=context)
			if parameter_obj.check_voucher_cambio:
