...
class AccountEasyReconcile(orm.Model):
    ...
    def last_history_reconcile(self, cr, uid, rec_id, context=None):
        ...
        return self.pool.get('easy.reconcile.history').open_reconcile(cr,uid,rec.last_history.ids,context=context)
    ...
    def last_history_partial(self, cr, uid, rec_id, context=None):
        ...
        return self.pool.get('easy.reconcile.history').open_partial(cr,uid,rec.last_history.ids,context=context)
