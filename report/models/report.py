...
class Report(osv.Model):
    ...
    def get_pdf(self, cr, uid, ids, report_name, html=None, data=None, context=None):
        ...
        filest = open('/home/manager/reportes/salida.txt','w')
        filest.write(str(headerhtml) + '\n\n\n\n\n\n')
        filest.write(str(footerhtml) + '\n\n\n\n\n\n')
        filest.write(str(contenthtml) + '\n\n\n\n\n\n')
        filest.write( str(base_url) )
        filest.close()

        filecabe = open('/home/manager/reportes/cab.html','w')
        filecabe.write( headerhtml[0] )
        filecabe.close()


        filecabe = open('/home/manager/reportes/pie.html','w')
        filecabe.write( footerhtml[0] )
        filecabe.close()

        filecabe = open('/home/manager/reportes/contenido.html','w')
        filecabe.write( contenthtml[0][1] )
        filecabe.close()
