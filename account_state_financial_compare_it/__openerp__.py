# -*- encoding: utf-8 -*-
{
	'name': 'Account State Financial Comprare IT',
	'category': 'account',
	'author': 'ITGrupo',
	'depends': ['account','account_state_financial_it'],
	'version': '1.0',
	'description':"""
...
3	INTERESES Y RENDIMIENTOS
	...
	'auto_install': False,
	'demo': [],
	'data':	['wizard/account_state_efective_view.xml','wizard/account_state_nature_view.xml','wizard/account_state_function_view.xml', 'wizard/account_balance_general_view.xml'],
	'installable': True
}
