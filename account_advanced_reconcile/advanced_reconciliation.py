...
class easy_reconcile_advanced_it(orm.TransientModel):

    _name = 'easy.reconcile.advanced.it'
    _inherit = 'easy.reconcile.advanced'
    ...
    def _skip_line(self, cr, uid, rec, move_line, context=None):
        ...
        skip on some conditions. ie: ref or partner_id is empty.
        """
        return not ( move_line.get('account_id') and move_line.get('partner_id') and move_line.get('nro_comprobante') and move_line.get('type_document_id'))
    ...
    def _matchers(self, cr, uid, rec, move_line, context=None):
        ...
        :return: tuple of tuples (key, value) where the keys are
            ...
            A matching key can have multiples values.
        """
        return (('partner_id',move_line['partner_id']),('account_id',move_line['account_id']),('nro_comprobante',(move_line['nro_comprobante'] or '' ).lower().strip()),('type_document_id',move_line['type_document_id']))  
    ...
    def _opposite_matchers(self, cr, uid, rec, move_line, context=None):
        ...
        yield ('nro_comprobante', (move_line['nro_comprobante'] or '').lower().strip())
