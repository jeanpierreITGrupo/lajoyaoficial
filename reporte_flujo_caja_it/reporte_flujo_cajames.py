...
left join (
	...
	where a2.date >= '""" + dinicio + """' and  a2.date < '""" + d1 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
left join (
	...
	left join account_move a2 on a2.id=aa.move_id
	left join account_period a3 on a3.id=a2.period_id
	where a2.date  = '""" + d1 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
left join (
	...
	left join account_move a2 on a2.id=aa.move_id
	left join account_period a3 on a3.id=a2.period_id
	where a2.date  = '""" + d2 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
left join (
	...
	left join account_move a2 on a2.id=aa.move_id
	left join account_period a3 on a3.id=a2.period_id
	where a2.date  = '""" + d3 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
left join (
	...
	left join account_move a2 on a2.id=aa.move_id
	left join account_period a3 on a3.id=a2.period_id
	where a2.date  = '""" + d4 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
left join (
	...
	left join account_move a2 on a2.id=aa.move_id
	left join account_period a3 on a3.id=a2.period_id
	where a2.date  = '""" + d5 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
left join (
	...
	left join account_move a2 on a2.id=aa.move_id
	left join account_period a3 on a3.id=a2.period_id
	where a2.date  = '""" + d6 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
left join (
	...
	left join account_move a2 on a2.id=aa.move_id
	left join account_period a3 on a3.id=a2.period_id
	where a2.date  = '""" + d7 + """' and left(a1.code,2)='10')
	and
	left(b1.code,2)<>'10'
...
order by c1.group,c1.order
  ...
  """)
		...
		self.env.cr.execute("""
			...
			where aa.code like '10%' and am.date >= '""" + dinicio + """' and  am.date < '""" + d1 + """'
		""")
